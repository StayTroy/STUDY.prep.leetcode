...
int main()
{
    ...
    // Test Case 1: Root = [1,3,null,null,2] (swapped 1 and 3)
    TreeNode* root1 = new TreeNode(1);
    root1->left = new TreeNode(3);
    root1->left->right = new TreeNode(2);

    std::cout << "Test Case 1 Before Recovery: ";
    std::vector<int> v1;
    ...
    std::cout << "Test Case 1 After Recovery: ";
    v1.clear();
    printInOrder(root1, v1);
    for(int x : v1) std::cout << x << " ";
    std::cout << "\n";
    ...
    std::cout << "Test Case 2 Before Recovery: ";
    std::vector<int> v2;
    ...
    std::cout << "Test Case 2 After Recovery: ";
    v2.clear();
    printInOrder(root2, v2);
    for(int x : v2) std::cout << x << " ";
    std::cout << "\n";
